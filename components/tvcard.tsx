...
const TVCard: React.FC<TVCardProps> = ({
    ...
    const { data: tvData, isLoading } = useSeasons(data.id);
    ...
    return (
        <div className="group bg-zinc-900 flex flex-shrink-0 relative w-[200px] md:w-[300px] h-[234px] md:h-[400px] m-1">
            ...
            <div className="hidden lg:block opacity-0 absolute top-0 transition duration-200 z-10  delay-300 w-full scale-0 group-hover:scale-110 group-hover:-translate-y-[6vw] group-hover:translate-x-[2vw] group-hover:opacity-100">
                <img
